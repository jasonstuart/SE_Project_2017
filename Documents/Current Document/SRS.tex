...
After compiling a .jar file should be present in the build folder of the Java project. This .exe file can be transferred to computers in the call center and will allow the application to run without the need for an IDE. It will require the use of the command prompt. Navigate to the file in the command prompt and then type: java -jar CallCenter.jar
